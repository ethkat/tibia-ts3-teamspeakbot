...
class BotConfigurationContainerStep0 extends React.Component {
  constructor(props) {
    super(props);
...
BotConfigurationContainerStep0.defaultProps = {
  isOpen: false,
  actions: {},
};

BotConfigurationContainerStep0.propTypes = {
...
BotConfigurationContainerStep0 = connect(
  mapStateToProps,
  mapDispatchToProps,
)(BotConfigurationContainerStep0);

export default BotConfigurationContainerStep0;
